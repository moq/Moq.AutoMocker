...
public sealed class FakeLoggingExtensionSourceGenerator : IIncrementalGenerator
{
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        ...
        // Only generate source if Microsoft.Extensions.Diagnostics.Testing is referenced
        context.RegisterSourceOutput(referencesFakeLogging, static (context, hasReference) =>
        {
            if (hasReference)
            {
