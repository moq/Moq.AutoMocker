...
| public type | description |
| --- | --- |
| class [AutoMockerDisposableResolver](Moq.AutoMock.Resolvers/AutoMockerDisposableResolver.md) | A resolver that resolves instances for IAutoMockerDisposable. |
...
| class [SelfResolver](Moq.AutoMock.Resolvers/SelfResolver.md) | Resolves calls to retireve AutoMocker with itself. |
