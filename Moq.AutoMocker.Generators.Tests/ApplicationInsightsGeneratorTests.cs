...
{
    private const string ExpectedApplicationInsightsV2GeneratedFile = """
        #nullable enable
    ...
    public async Task WhenApplicationInsightsAssemblyIsReferenced_ExtensionMethodIsGenerated()
    {
        await new VerifyCS.Test
        {
            ...
            TestState =
            {
                GeneratedSources =
                {
                    GetSourceFile(ExpectedApplicationInsightsV2GeneratedFile, "AutoMockerApplicationInsightsExtensions.g.cs")
                }
            }
        }.RunAsync(TestContext.CancellationToken);
    }
